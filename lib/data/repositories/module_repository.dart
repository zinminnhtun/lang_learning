...
class ModuleRepository {
  ...
  Module(
    ...
    description: 'အကူအညီ သို့မဟုတ် ကောင်းမှုတစ်ခုအတွက် ကျေးဇူးတင်စကား ပြောဆိုခြင်း။',
    icon: '🙏',
    lessons: [
      Lesson(id: 'lesson1', title: 'ขอบคุณครับ/ค่ะ', subtitle: 'ကျေးဇူးတင်ပါတယ်'),
    ],
  ),
  Module(
    id: 'module3',
    title: 'တောင်းပန်စကား ဆိုခြင်း',
    description: 'အမှားတစ်ခုခုအတွက် သို့မဟုတ် အနှောင့်အယှက်ဖြစ်မှုအတွက် တောင်းပန်ခြင်း။',
    icon: '😔',
    lessons: [
      Lesson(id: 'lesson1', title: 'ขอโทษครับ/ค่ะ', subtitle: 'တောင်းပန်ပါတယ်'),
    ],
  ),
  Module(
    id: 'module4',
  ...
  Module(
    ...
    icon: '👎',
    lessons: [
      Lesson(id: 'lesson1', title: 'ไม่ใช่ครับ/ค่ะ', subtitle: 'မဟုတ်ပါဘူး'),
    ],
  ),
  Module(
    id: 'module6',
    ...
    icon: '😊',
    lessons: [
      Lesson(id: 'lesson1', title: 'สบายดีไหมครับ/คะ', subtitle: 'နေကောင်းလား'),
    ],
  ),
  Module(
    id: 'module7',
    ...
    icon: '🗣️',
    lessons: [
      Lesson(id: 'lesson1', title: 'ผมชื่อ... / ฉันชื่อ...', subtitle: 'ကျွန်တော့်နာမည်... / ကျွန်မနာမည်...'),
    ],
  ),
  Module(
    id: 'module8',
    ...
    icon: '🛒',
    lessons: [
      Lesson(id: 'lesson1', title: 'อันนี้เท่าไหร่ครับ/คะ', subtitle: 'ဒါဘယ်လောက်လဲ'),
    ],
  ),
  Module(
    id: 'module9',
    ...
    icon: '🍜',
    lessons: [
      Lesson(id: 'lesson1', title: 'สั่งอาหารครับ/ค่ะ', subtitle: 'အစားအစာမှာချင်ပါတယ်'),
    ],
  ),
  Module(
    id: 'module10',
    ...
    icon: '💧',
    lessons: [
      Lesson(id: 'lesson1', title: 'ขอน้ำดื่มหน่อยครับ/ค่ะ', subtitle: 'သောက်ရေหน่อย တောင်းပါ'),
    ],
  ),
  Module(
    id: 'module11',
    ...
    icon: '🌶️',
    lessons: [
      Lesson(id: 'lesson1', title: 'ไม่ใส่พริกครับ/ค่ะ', subtitle: 'ငရုတ်သီးမထည့်ပါနဲ့'),
    ],
  ),
  Module(
    id: 'module12',
    ...
    icon: '😋',
    lessons: [
      Lesson(id: 'lesson1', title: 'อร่อยมากครับ/ค่ะ', subtitle: 'အရမ်းစားလို့ကောင်းတယ်'),
    ],
  ),
  Module(
    id: 'module13',
    ...
    icon: '💰',
    lessons: [
      Lesson(id: 'lesson1', title: 'คิดเงินด้วยครับ/ค่ะ', subtitle: 'ရှင်းမယ်'),
    ],
  ),
  Module(
    id: 'module14',
    ...
    icon: '🗺️',
    lessons: [
      Lesson(id: 'lesson1', title: '...อยู่ที่ไหนครับ/คะ', subtitle: '...ဘယ်မှာလဲ'),
    ],
  ),
  Module(
    id: 'module15',
  ...
  Module(
    ...
    icon: '✅',
    lessons: [
      Lesson(id: 'lesson1', title: 'เสร็จแล้วครับ/ค่ะ', subtitle: 'ပြီးပါပြီ'),
    ],
  ),
  Module(
    id: 'module19',
    ...
    icon: '🆘',
    lessons: [
      Lesson(id: 'lesson1', title: 'ช่วยด้วยครับ/ค่ะ', subtitle: 'ကူညီပါဦး'),
    ],
  ),
  Module(
    id: 'module20',
    ...
    icon: '👌',
    lessons: [
      Lesson(id: 'lesson1', title: 'เข้าใจแล้วครับ/ค่ะ', subtitle: 'နားလည်ပါပြီ'),
    ],
  ),
  Module(
    id: 'module21',
    ...
    icon: '❓',
    lessons: [
      Lesson(id: 'lesson1', title: 'ไม่เข้าใจครับ/ค่ะ', subtitle: 'နားမလည်ပါဘူး'),
    ],
  ),
  Module(
    id: 'module22',
    ...
    icon: '🤒',
    lessons: [
      Lesson(id: 'lesson1', title: 'ไม่สบายครับ/ค่ะ', subtitle: 'နေမကောင်းဘူး'),
    ],
  ),
  Module(
    id: 'module23',
    ...
    icon: '🏥',
    lessons: [
      Lesson(id: 'lesson1', title: 'อยากไปโรงพยาบาลครับ/ค่ะ', subtitle: 'ဆေးရုံသွားချင်ပါတယ်'),
    ],
  ),
  Module(
    id: 'module24',
    ...
    icon: '⏰',
    lessons: [
      Lesson(id: 'lesson1', title: 'ตอนนี้กี่โมงแล้วครับ/คะ', subtitle: 'အခုဘယ်နှနာရီရှိပြီလဲ'),
    ],
  ),
  Module(
    id: 'module25',
    ...
    icon: '📅',
    lessons: [
      Lesson(id: 'lesson1', title: 'วันนี้', subtitle: 'ဒီနေ့'),
    ],
  ),
  Module(
    id: 'module26',
  ...
  Module(
    ...
    description: 'တစ်စုံတစ်ဦးနှင့် တွေ့ဆုံရသည့်အတွက် ဝမ်းမြောက်ကြောင်း ဖော်ပြခြင်း။',
    icon: '🤝',
    lessons: [
      Lesson(id: 'lesson1', title: 'ยินดีที่ได้รู้จักครับ/ค่ะ', subtitle: 'တွေ့ရတာဝမ်းသာပါတယ်'),
    ],
  ),
  Module(
    id: 'module28',
    ...
    icon: 'ㅂ', // Using a generic wave symbol if specific emoji is unavailable
    lessons: [
      Lesson(id: 'lesson1', title: 'แล้วพบกันใหม่นะครับ/นะคะ', subtitle: 'နောက်မှတွေ့ကြတာပေါ့'),
    ],
  ),
  Module(
    id: 'module29',
    ...
    icon: '🐢',
    lessons: [
      Lesson(id: 'lesson1', title: 'พูดช้าๆ หน่อยครับ/ค่ะ', subtitle: 'ဖြည်းဖြည်းပြောပေးပါ'),
    ],
  ),
  Module(
    id: 'module30',
    title: 'တစ်ခုခု ရှာဖွေနေကြောင်း ပြောဆိုခြင်း',
    description: 'မိမိရှာဖွေနေသည့် ပစ္စည်း သို့မဟုတ် နေရာကို မေးမြန်းခြင်း။',
    icon: '🔍',
    lessons: [
      Lesson(id: 'lesson1', title: 'กำลังมองหา...อยู่ครับ/ค่ะ', subtitle: '...ကို ရှာနေတာပါ'),
    ],
  ),
  Module(
    id: 'module31',
    title: 'ဟိုတယ်တွင် Check-in လုပ်ခြင်း',
    description: 'ဟိုတယ်သို့ ရောက်ရှိကြောင်း အကြောင်းကြား၍ အခန်းတောင်းခံခြင်း။',
    icon: '🛎️',
    lessons: [
      Lesson(id: 'lesson1', title: 'เช็คอินครับ/ค่ะ', subtitle: 'Check-in လုပ်ချင်ပါတယ်'),
    ],
  ),
  Module(
    id: 'module32',
    ...
    icon: '🤔',
    lessons: [
      Lesson(id: 'lesson1', title: 'อันนี้คืออะไรครับ/คะ', subtitle: 'ဒါဘာလဲခင်ဗျ/ရှင့်'),
    ],
  ),
  Module(
    id: 'module33',
    title: 'ရေချိုးခန်း ဘယ်မှာလဲ မေးခြင်း',
    description: 'အများသုံး သို့မဟုတ် ကိုယ်ပိုင်ရေချိုးခန်းတည်နေရာ မေးမြန်းခြင်း။',
    icon: '🚻',
    lessons: [
      Lesson(id: 'lesson1', title: 'ห้องน้ำอยู่ที่ไหนครับ/คะ', subtitle: 'ရေချိုးခန်း ဘယ်မှာလဲ'),
    ],
  ),
  Module(
    id: 'module34',
    ...
    icon: '💼',
    lessons: [
      Lesson(id: 'lesson1', title: 'ไปทำงานครับ/ค่ะ', subtitle: 'အလုပ်သွားမလို့ပါ'),
    ],
  ),
  Module(
    id: 'module35',
    ...
    icon: '🛍️',
    lessons: [
      Lesson(id: 'lesson1', title: 'ไปตลาดครับ/ค่ะ', subtitle: 'ဈေးသွားမလို့ပါ'),
    ],
  ),
  Module(
    id: 'module36',
    ...
    icon: '📱',
    lessons: [
      Lesson(id: 'lesson1', title: 'ขอเบอร์โทรศัพท์หน่อยได้ไหมครับ/คะ', subtitle: 'ဖုန်းနံပါတ်လေး တောင်းလို့ရမလား'),
    ],
  ),
  Module(
    id: 'module37',
    ...
    icon: '⏳',
    lessons: [
      Lesson(id: 'lesson1', title: 'รอสักครู่นะครับ/นะคะ', subtitle: 'ခဏစောင့်ပေးပါ'),
    ],
  ),
  Module(
    id: 'module38',
    title: 'အလွန်ပူကြောင်း ပြောဆိုခြင်း',
    description: 'ရာသီဥတု သို့မဟုတ် အရာဝတ္ထုတစ်ခု အလွန်ပူကြောင်း ဖော်ပြခြင်း။',
    icon: '☀️',
    lessons: [
      Lesson(id: 'lesson1', title: 'ร้อนมากครับ/ค่ะ', subtitle: 'အရမ်းပူတယ်'),
    ],
  ),
  Module(
    id: 'module39',
    title: 'အလွန်အေးကြောင်း ပြောဆိုခြင်း',
    description: 'ရာသီဥတု သို့မဟုတ် အရာဝတ္ထုတစ်ခု အလွန်အေးကြောင်း ဖော်ပြခြင်း။',
    icon: '❄️',
    lessons: [
      Lesson(id: 'lesson1', title: 'หนาวมากครับ/ค่ะ', subtitle: 'အရမ်းအေးတယ်'),
    ],
  ),
  Module(
    id: 'module40',
    ...
    icon: '🍔',
    lessons: [
      Lesson(id: 'lesson1', title: 'หิวข้าวครับ/ค่ะ', subtitle: 'ဗိုက်ဆာတယ်'),
    ],
  ),
  Module(
    id: 'module41',
  ...
  Module(
    ...
    icon: '😩',
    lessons: [
      Lesson(id: 'lesson1', title: 'เหนื่อยมากครับ/ค่ะ', subtitle: 'အရမ်းပင်ပန်းတယ်'),
    ],
  ),
  Module(
    id: 'module43',
    ...
    icon: '😴',
    lessons: [
      Lesson(id: 'lesson1', title: 'ง่วงนอนครับ/ค่ะ', subtitle: 'အိပ်ချင်တယ်'),
    ],
  ),
  Module(
    id: 'module44',
    title: 'ဘယ်ကလာသလဲ မေးမြန်းခြင်း',
    description: 'တစ်စုံတစ်ဦး၏ ဇာတိ သို့မဟုတ် နေရပ်လိပ်စာကို မေးမြန်းခြင်း။',
    icon: '🌏',
    lessons: [
      Lesson(id: 'lesson1', title: 'มาจากที่ไหนครับ/คะ', subtitle: 'ဘယ်ကလာတာလဲ'),
    ],
  ),
  Module(
    id: 'module45',
    ...
    icon: '🎂',
    lessons: [
      Lesson(id: 'lesson1', title: 'อายุเท่าไหร่ครับ/คะ', subtitle: 'အသက်ဘယ်လောက်ရှိပြီလဲ'),
    ],
  ),
  Module(
    id: 'module46',
    title: 'ဓာတ်ပုံရိုက်ခွင့် တောင်းခြင်း',
    description: 'တစ်စုံတစ်ဦး သို့မဟုတ် တစ်စုံတစ်ခုကို ဓာတ်ပုံရိုက်ရန် ခွင့်တောင်းခြင်း။',
    icon: '📸',
    lessons: [
      Lesson(id: 'lesson1', title: 'ถ่ายรูปได้ไหมครับ/คะ', subtitle: 'ဓာတ်ပုံရိုက်လို့ရမလား'),
    ],
  ),
  Module(
    id: 'module47',
    ...
    icon: '🤝',
    lessons: [
      Lesson(id: 'lesson1', title: 'ให้ช่วยอะไรไหมครับ/คะ', subtitle: 'ဘာအကူအညီပေးရမလဲ'),
    ],
  ),
  Module(
    id: 'module48',
    title: 'ကိစ္စမရှိကြောင်း ပြောဆိုခြင်း',
    description: 'တောင်းပန်စကား သို့မဟုတ် ကျေးဇူးတင်စကားကို တုံ့ပြန်သည့်အနေဖြင့် ပြောဆိုခြင်း။',
    icon: '🤷',
    lessons: [
      Lesson(id: 'lesson1', title: 'ไม่เป็นไรครับ/ค่ะ', subtitle: 'ကိစ္စမရှိပါဘူး'),
    ],
  ),
  Module(
    id: 'module49',
    ...
    icon: '🚕',
    lessons: [
      Lesson(id: 'lesson1', title: 'ค่าโดยสารเท่าไหร่ครับ/คะ', subtitle: 'ကားခဘယ်လောက်လဲ'),
    ],
  ),
  Module(
    id: 'module50',
    title: 'အောင်မြင်ပါစေကြောင်း ဆုတောင်းခြင်း',
    description: 'တစ်စုံတစ်ဦး၏ ကြိုးပမ်းမှုအတွက် အောင်မြင်စေရန် ဆုမွန်ကောင်းတောင်းခြင်း။',
    icon: '🎉',
    lessons: [
      Lesson(id: 'lesson1', title: 'ขอให้โชคดีนะครับ/นะคะ', subtitle: 'ကံကောင်းပါစေ'),
    ],
  ),
];
  }
