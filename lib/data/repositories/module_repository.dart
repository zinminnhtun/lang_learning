  ...
  List<Module> fetchModules() {
    return [
      Module(
        ...
        icon: '👋',
        lessons: [
          Lesson(id: 'lesson1', title: 'สวัสดีครับ/ค่ะ', subtitle: 'မင်္ဂလာပါ', quizzes: []),
        ],
      ),
      Module(
        id: 'module2',
      ...
      Module(
        ...
        icon: '👍',
        lessons: [
          Lesson(id: 'lesson1', title: 'ใช่ครับ/ค่ะ', subtitle: 'ဟုတ်ကဲ့', quizzes: []),
        ],
      ),
      Module(
        id: 'module5',
      ...
      Module(
        ...
        icon: '⬆️',
        lessons: [
          Lesson(id: 'lesson1', title: 'ตรงไป', subtitle: 'တည့်တည့်သွားပါ', quizzes: []),
        ],
      ),
      Module(
        id: 'module16',
        ...
        icon: '⬅️',
        lessons: [
          Lesson(id: 'lesson1', title: 'เลี้ยวซ้าย', subtitle: 'ဘယ်ဘက်ကွေ့ပါ', quizzes: []),
        ],
      ),
      Module(
        id: 'module17',
        ...
        icon: '➡️',
        lessons: [
          Lesson(id: 'lesson1', title: 'เลี้ยวขวา', subtitle: 'ညာဘက်ကွေ့ပါ', quizzes: []),
        ],
      ),
      Module(
        id: 'module18',
      ...
      Module(
        ...
        icon: '📅',
        lessons: [Lesson(id: 'lesson1', title: 'วันนี้', subtitle: 'ဒီနေ့', quizzes: [])],
      ),
      Module(
        id: 'module26',
        ...
        icon: '🗓️',
        lessons: [
          Lesson(id: 'lesson1', title: 'พรุ่งนี้', subtitle: 'မနက်ဖြန်', quizzes: []),
        ],
      ),
      Module(
        id: 'module27',
      ...
      Module(
        ...
        icon: '🥤',
        lessons: [
          Lesson(id: 'lesson1', title: 'หิวน้ำครับ/ค่ะ', subtitle: 'ရေဆာတယ်', quizzes: []),
        ],
      ),
      Module(
        id: 'module42',
